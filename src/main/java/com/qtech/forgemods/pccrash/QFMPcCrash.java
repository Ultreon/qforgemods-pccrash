...
@Mod(QFMPcCrash.modId)
@Mod.EventBusSubscriber(modid = QFMPcCrash.modId, bus = Mod.EventBusSubscriber.Bus.MOD)
public class QFMPcCrash implements QFMCorePlugin {
    /**
     * QForgeMod's Logger
     */
    ...
    static {
        ...
        // Get stream.
        InputStream qfmArgsStream = QFMPcCrash.class.getResourceAsStream("/META-INF/qfm_args.json");
